...
public class  objectDetectorClass {
    ...
    //create another interpreter for model
    ...
    //adding the model and input sign in object detection class
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        // if we do not do this process you will get improper prediction, less no. of object
      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            //looping thru each hand which is detected
            ...
            if(score_value>0.5){
                ...
                //(x2,y2) is the ending point of the hand
                ...
                //convert this cropped Mat to bitmap
                Bitmap bitmap1=null;
